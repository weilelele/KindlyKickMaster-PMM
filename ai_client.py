...
_SYSTEM = [
    {
        "type": "text",
        "text": """你是一个专业的项目管理助手，服务于一个小型敏捷团队。

核心职责：
1. 从会议记录中提取并结构化待办任务
2. 跟踪和更新成员的工作进展
3. 生成简洁有力的每日任务播报，督促团队完成任务
4. 在群组中以积极但不失严肃的方式提醒成员
...
async def generate_daily_summary(
    ...
    period_instruction = (
        "这是早间播报。总结今日各成员的主要任务，语气积极鼓励，让大家有干劲。"
        if period == "morning"
        else "这是晚间播报。总结今日进展，对尚未完成的任务适当施压督促，直接不客气。"
    )
